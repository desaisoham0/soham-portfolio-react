    ...
    <header className="container mx-auto px-4 py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8">
        ...
        <div className="relative group">
          <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden border-4 border-[#b5d2e6] dark:border-[#37464f] shadow-2xl">
            <img
              src={profilePicture}
              alt="Soham Desai"
        ...
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#000437] dark:text-[#dce6ec] font-montserrat tracking-tight">
          ...
          <div className="space-y-2">
            <p className="text-lg sm:text-xl md:text-2xl text-[#000437]/80 dark:text-[#dce6ec]/80 font-medium">
              Software Engineer
            </p>
            <p className="text-sm sm:text-base md:text-lg text-[#000437]/60 dark:text-[#dce6ec]/60 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="pt-6 sm:pt-8">
          <a
            href="#contact"
            className="group inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-[#cd7900] dark:bg-[#cd7900] text-[#dce6ec] dark:text-[#dce6ec] rounded-full font-semibold text-base sm:text-lg transition-all duration-300 hover:bg-[#bf7202] dark:hover:bg-[#bf7202] hover:scale-105 border-b-4 border-pastelYellow-800 dark:border-pastelYellow-800"
          >
